...
exports.getLoeweSearchResults = exports.generateProductUrlHandle = void 0;
...
const getLoeweSearchResults = ({ page = "1", }) => __awaiter(void 0, void 0, void 0, function* () {
    //
    ...
    const response = yield fetch(`https://www.loewe.com/eur/fr/search?${searchParams.toString()}`, {
        // verbose: true,
        headers: {
    ...
    fs_1.default.writeFileSync("body.html", html, "utf8");
    $(".capds-productsearchresult--4tile-grid").each((i, el) => {
        const product = $(el);
        const images = [];
        const unparsed_json = product.attr("data-product");
        ...
        products.push({
            ...
            title: json.name,
            currency: "RUB",
            gender: [(0, utils_1.capitalizeFirstLetter)(json.category.split(" / ")[0])],
    ...
    const totalItems = parseInt($(".capds-productsearchresul__results").text().replace(".", ""));
    return {
...
exports.getLoeweSearchResults = getLoeweSearchResults;
