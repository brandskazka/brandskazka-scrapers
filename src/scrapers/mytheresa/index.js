...
exports.getAllProducts = exports.getAllBrands = exports.gender = void 0;
...
let headers = {
    ...
    "X-Country": "FR",
    "X-Region": "BY",
    "X-Section": exports.gender,
    "Accept-Language": "en",
    "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 17_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 mythapp (5.8.1 build 202405160 react-native; Apple iPhone 15 Pro; en-us|US; iOS 17.5.1)",
};
const getAllBrands = () => __awaiter(void 0, void 0, void 0, function* () {
    headers["X-Section"] = exports.gender;
    const body = JSON.stringify({
        operationName: "DesignerListQuery",
        variables: { designerCategoryId: null },
        query: "query DesignerListQuery($designerCategoryId: String) {\n  designerList(designerCategoryId: $designerCategoryId) {\n    letter\n    designers {\n      name\n      slug\n      flag\n      __typename\n    }\n    __typename\n  }\n}\n",
    });
    const response = yield fetch("https://api.mytheresa.com/api", {
        method: "POST",
        headers,
        body,
    });
...
const getAllProducts = (page = 1, slug) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const json = yield response.json();
    const pagination = Object.assign({}, json.data.xProductListingPage.pagination);
    //   console.log(json.data.xProductListingPage.products[0]);
    const products = json.data.xProductListingPage.products.map((product) => {
        var _a;
        return ({
            id: product.sku,
            ...
            brand: {
                id: (_a = product.designer) === null || _a === void 0 ? void 0 : _a.toString().toLowerCase().trim().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/[^a-z0-9\s-]/g, "").replace(/\s+/g, "-").replace(/-+/g, "-").replace(/^-+|-+$/g, "").replaceAll("/", "-"),
                name: product.designer,
                description: product.designer,
            },
            images: product.displayImages.map((url, i) => ({
                url,
                order: i + 1,
                size: "1000",
            })),
