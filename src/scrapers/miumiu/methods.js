...
exports.getMiuMiuSearchResults = exports.defaultHeaders = void 0;
...
const getMiuMiuSearchResults = ({ page = "1", }) => __awaiter(void 0, void 0, void 0, function* () {
    const query = ``;
    ...
    const response = yield fetch(`https://2nyr2y6a02-dsn.algolia.net/1/indexes/MiuMiu_FR_en/query?${searchParams.toString()}`, {
        method: "POST",
...
exports.getMiuMiuSearchResults = getMiuMiuSearchResults;
